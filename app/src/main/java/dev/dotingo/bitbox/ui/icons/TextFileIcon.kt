        ...
        _TextFileIcon = ImageVector.Builder(
            ...
            path(
                fill = Brush.linearGradient(
                    ...
                    start = Offset(19.586f, 19.586f),
                    end = Offset(28.414f, 28.414f)
                )
            ) {
                moveTo(30f, 26f)
                horizontalLineTo(18f)
                curveTo(16.894f, 26f, 16f, 25.104f, 16f, 24f)
                curveTo(16f, 22.896f, 16.894f, 22f, 18f, 22f)
                horizontalLineTo(30f)
                curveTo(31.106f, 22f, 32f, 22.896f, 32f, 24f)
                curveTo(32f, 25.104f, 31.106f, 26f, 30f, 26f)
                close()
            }
            path(
                fill = Brush.linearGradient(
                    ...
                    start = Offset(18.586f, 28.586f),
                    end = Offset(25.414f, 35.414f)
                )
            ) {
                moveTo(26f, 34f)
                horizontalLineTo(18f)
                curveTo(16.894f, 34f, 16f, 33.104f, 16f, 32f)
                curveTo(16f, 30.896f, 16.894f, 30f, 18f, 30f)
                horizontalLineTo(26f)
                curveTo(27.106f, 30f, 28f, 30.896f, 28f, 32f)
                curveTo(28f, 33.104f, 27.106f, 34f, 26f, 34f)
                close()
            }
        }.build()
